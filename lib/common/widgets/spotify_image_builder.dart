...
class _SpotifyImageBuilderState extends State<SpotifyImageBuilder> {
  static const url = 'https://upload.wikimedia.org/wikipedia/commons/thumb/4/49/A_black_image.jpg/640px-A_black_image.jpg';
                    ...
                    Positioned.fill(
                      child: DecoratedBox(
                        decoration: BoxDecoration(
                          gradient: RadialGradient(colors: [color.withOpacity(0.2), color.withOpacity(0.4)], radius: 1),
                        ),
                      ...
                      child: DecoratedBox(
                        decoration: BoxDecoration(
                          gradient: RadialGradient(
                              colors: [Colors.black38.withOpacity(0.1), Colors.black38.withOpacity(0.3)], radius: 1),
                        ),
                      ),
                    ),
                  ],
