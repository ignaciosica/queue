...
_$_FirestoreTrack _$$_FirestoreTrackFromJson(Map<String, dynamic> json) => _$_FirestoreTrack(
...
Map<String, dynamic> _$$_FirestoreTrackToJson(_$_FirestoreTrack instance) => <String, dynamic>{
